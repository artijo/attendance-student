...
function AttendenceActivityHistory() {
    ...
    const sliceActivityList = activityFiltered.slice((currentPage - 1) * itemsPerPage, currentPage * itemsPerPage);
    ...
    const filterActivity = (text) => {
        ...
        const filtered = activity.filter((act) => {
            ...
            const type = act.activityType ? act.activityType.actTypeName.toLowerCase() : "";
            return (
        ...
        <div>
            ...
            <div className="flex items-center border border-gray-300 rounded-xl px-3 py-2 mb-4 w-full max-w-md shadow-sm focus-within:ring-2 focus-within:ring-blue-500">
                ...
                <input
                    ...
                    placeholder="Ex. ชื่อกิจกรรม, สถานที่, ประเภทกิจกรรม"
                />
            </div>
            ...
            <div className="overflow-auto max-h-[400px]">
                <table className="w-full text-sm text-left rtl:text-right text-gray-500">
                    <thead className="rel text-xs text-gray-700 uppercase bg-gray-50 sticky top-0 z-10">
                        <tr>
                            <th scope="col" className="bg-gray-50 px-6 py-3 whitespace-nowrap">
                                กิจกรรม
                            </th>
                            <th scope="col" className="bg-gray-50 px-6 py-3 whitespace-nowrap">
                                ระยะเวลากิจกรรม
                ...
                <div className="border-t border-line py-4">
                    <div className="flex items-center justify-between">
                        <p className="text-sm text-text-color-alt">
                            แสดง <span className="font-medium text-text-color">{sliceActivityList.length}</span> จาก <span className="font-medium text-text-color">{activityFiltered.length}</span> รายการ
                        </p>
