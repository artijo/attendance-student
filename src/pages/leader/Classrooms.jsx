            ...
            >
              ...
              <div className="p-4">
                ...
                <div className="mt-5 flex flex-col gap-2">
                  ...
                  <Link
                    to={`/leader/classrooms/${classroom.classId}/attendance`}
                    className="w-full py-2 bg-primary text-white rounded-md hover:bg-primary/80 transition-colors text-center flex items-center justify-center"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-5 w-5 mr-1"
